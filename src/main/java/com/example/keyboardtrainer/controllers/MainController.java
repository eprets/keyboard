...
import com.example.keyboardtrainer.services.ResultService;
...
public class MainController {
    ...
    public String viewProgress(Model model, Principal principal) {
        User currentUser = userService.findByUsername(principal.getName());
        List<Result> results = resultService.getResultsByUser(currentUser);
